...
// Verifying performance - how do you check what OS is there? What if you don’t have CentOS? Do you still use the command shown???
----
...
== Testing Disk IOPS
// Testing IOPS - is this done from each node? How do you know what path to use? I got command not found error.???
// How can the user verify disk size ???

Depending on your hardware or virtualization provider, you can configure disk IOPS (I/O Operations Per Second). Using the `iops` command, you can verify available IOPS:
