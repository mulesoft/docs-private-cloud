...
[NOTE]
By default, the netcat tool is not included with Anypoint Platform Private Cloud Edition. If you receive a `command not found` error, you can install the `netcat` tool using the instructions in <???> 
