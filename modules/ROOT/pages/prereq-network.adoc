...
* If you plan to use the GUI installer to install Anypoint Platform Private Cloud Edition, you must enable port 61009.
...
Your network must include an SMTP server to manage e-mail alerts that are triggered by the platform. Anypoint Platform Private Cloud Edition must be connected to this SMTP server. For additional information, refer to the instructions in xref:access-management-SMTP.adoc[Configure SMTP in Anypoint Private Cloud].
