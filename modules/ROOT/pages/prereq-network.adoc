...
|TCP | 3023-3026 | Cluster control plane | Anypoint Platform PCE nodes | Anypoint Platform PCE nodes
...
|TCP | 32009 | Gravity internal API | controllers | Anypoint Platform PCE nodes
...
|TCP | 30883 | Mule Runtime Authentication Service | Load Balancer | Anypoint Platform PCE nodes
|===
