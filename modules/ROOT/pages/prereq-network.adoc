...
|TCP | 6443 | Kubernetes API server | all | PCE nodes
...
|TCP | 10251, 10252 | Kubernetes controller-manager and scheduler | all | PCE nodes
|TCP | 5000 | Docker registry | all | PCE nodes
|TCP | 3009-3012 | Cluster control plane | all | PCE nodes
|TCP | 3022 | Cluster control plane | all | all
|TCP | 3023-3026 | Cluster control plane | all | PCE nodes
...
|TCP | 32009 | Ops Center Admin UI | Load Balancer | PCE nodes
|TCP | 32009 | Gravity internal API | controllers | all
|TCP | 30080 | HTTP public access | Load Balancer | PCE nodes
|TCP | 30443 | HTTPS public access | Load Balancer | PCE nodes
|TCP | 30889 | Mule Runtime Websocket | Load Balancer | PCE nodes
|TCP | 30883 | Mule Runtime Websocket (auth) | Load Balancer | PCE nodes
|===
