...
Anypoint Platform PCE version 3.0.2 includes support for RHEL and CentOS versions 8.4 and 8.5.
...
Obtain the installer archive (`anypoint-3.0.x-installer.tar.gz`) and license key from your MuleSoft account representative.
