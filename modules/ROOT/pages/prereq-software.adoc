...
* Tool to Verify Kubectl Command is Available
...
Uninstall Docker from all servers running the Anypoint Platform Private Cloud Edition. The Anypoint Platform installation includes a Docker package officially supported by Kubernetes.
