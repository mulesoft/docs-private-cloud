...
The PCE command line tool `pcectl` that enables you to perform installations supports *RHEL 8* and above.

=== Environment OS Requirements

Anypoint Platform PCE has been tested on environments on the following operating systems: `RHEL 8.8`

For environment OS requirements, please refer to the documentation corresponding to the chosen `Kubernetes` distribution:

* https://docs.rke2.io/install/requirements#operating-systems[RKE2 Operating System Requirements]
* https://anywhere.eks.amazonaws.com/docs/osmgmt/overview/[EKS Anywhere Operating System Management]
