...
* PCE versions 2.1.0 and 2.1.1:
** Red Hat Enterprise Linux (RHEL) 7.8, 8.1, and 8.2 
** CentOS 7.8, 8.1, and 8.2 

* PCE version 2.1.2:
** Red Hat Enterprise Linux (RHEL) 7.8, 7.9, 8.1, 8.2, and 8.3
** CentOS 7.8, 7.9, 8.1, 8.2, and 8.3
...
running the installer. Review any custom profiles with your MuleSoft representative.
...
Obtain the installer archive (`anypoint-2.1.x-installer.tar.gz`) and license key from your MuleSoft account representative.
