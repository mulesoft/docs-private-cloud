...
Before you install or upgrade Anypoint Private Cloud on all nodes, run the `gravity check` script to verify that 
...
* xref:config-workflow.adoc[Configure Anypoint Platform Private Cloud]
