...
[NOTE]
==
If you perform a DNS update that changes the endpoints that Mule runtimes use to connect to Runtime Manager, you must restart the Mule runtimes before they can connect to the new endpoints.
==
