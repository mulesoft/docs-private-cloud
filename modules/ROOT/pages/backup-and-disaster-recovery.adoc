...
The InfluxDB backup and restore script is in the Anypoint Platform PCE environment: `/var/lib/gravity/site/packages/unpacked/gravitational.io/anypoint/3.1.0*/resources/kubernetes/amv-backup-restore/amv-backup-restore.sh`
