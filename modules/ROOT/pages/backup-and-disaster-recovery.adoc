...
This topic describes how to configure backups for Anypoint Private Cloud. It also describes how to perform a system restore from a backup.
...
[WARNING]
You can not perform a backup between different versions of Anypoint Platform Private Cloud. The new installation you create must be using the same version of Anypoint Platform Private Cloud as your backup.
