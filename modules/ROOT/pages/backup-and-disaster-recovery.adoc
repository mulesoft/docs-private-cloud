...
Anypoint Monitoring and Visualizer backup and restore are outside the normal Gravity backup and restore mechanism, and require a separate procedure.
...
If Anypoint Monitoring and Visualizer are enabled, follow these procedures to back up and restore them.

Anypoint Monitoring and Visualizer backup and restore are outside the normal Gravity backup and restore mechanism, and require additional procedures.
...
Anypoint Monitoring and Visualizer holds configuration for the Monitoring and Visualizer components in a Postgres database. The default Gravity mechanism backs up and restores this database.
