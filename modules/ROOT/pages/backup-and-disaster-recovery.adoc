...
Anypoint Monitoring and Visualizer backup and restore are outside the normal Gravitational backup and restore mechanism, and require a separate procedure.
