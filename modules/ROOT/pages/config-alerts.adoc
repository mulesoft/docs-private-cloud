...
Measurements are stored in https://prometheus.io/docs/introduction/overview/[Prometheus^] and read by https://prometheus.io/docs/alerting/latest/alertmanager/[Alertmanager^]. Alertmanager sends emails when an alert is triggered.
