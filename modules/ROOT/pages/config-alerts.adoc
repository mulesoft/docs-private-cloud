...
* Verify that your SMTP server can send and receive emails using the addresses you configure as the `FROM` and `TO` addresses defined you configured alerts delivery.
