...
When the InfluxDB license is updated, add the key to the secret in the default namespace, then ensure it is running in the pods.
...
----
+
. Find the old key in influxdb.com, typically on line 29:
+
----
