...
Refer to the xref:release-notes::pce/anypoint-private-cloud-2.0.4-release-notes#upgrade-paths[Upgrade Paths] section in the Anypoint Platform PCE release notes for additional information about upgrading Anypoint Platform PCE to the most recent version.
