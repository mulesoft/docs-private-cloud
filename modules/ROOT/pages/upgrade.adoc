...
[NOTE]
When you upgrade from a previous Anypoint Platform PCE version, all policies available in the previous version remain. Although policies are not replaced, additional policies might be included with the upgrade.
