...
If Access Management or the platform is not accessible follow the xref:https://pce-runbook.kbuild.msap.io/content/2.1.x/installation/setting-user-dns-nfs.html#wrong-setup-of-the-platform-dns[Wrong setup of the platform DNS] runbook entry to configure DNS via the command line.
