...
[NOTE]
====
* This is the process to upgrade from PCE 2.0.x to PCE 2.1.0. 
* If you are upgrading from previous versions of PCE, you need to upgrade to PCE 2.0.4 first and then upgrade to PCE 2.1.0 from it. 
====
