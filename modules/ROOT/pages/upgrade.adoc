...
Refer to the xref:release-notes/pce/anypoint-private-cloud-2.0.3-release-notes#upgrade-paths[Upgrade Paths) section in the Anypoint Platform Private Cloud Edition (Anypoint Platform PCE) release notes for information about upgrading Anypoint Platform PCE to the most recent version.
...
The following steps describe how to migrate Anypoint Platform PCE and the Anypoint Platform PCE infrastructure. You must also upgrade your applications to work with the new version of Anypoint Platform PCE. Contact your MuleSoft customer success representative for more information.
...
+
[WARNING]
Before accessing Anypoint Platform PCE, ensure that you configure your NSF servers described in the following step. Failure to configure NFS before accessing the platform can result in data loss.

. After upgrading Anypoint Platform PCE, configure it to use the required NFS server.
+
