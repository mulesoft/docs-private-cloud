...
|===
| Name | Description
| TF_VAR_ami_name | Specifies the AMI name to be used for the instances. Use the AMI name and NOT the AMI ID. If you do not set this variable, the provisioner uses the folowing AMI by default: `RHEL-7.4_HVM_GA-20170808-x86_64-2-Hourly2-GP2`
