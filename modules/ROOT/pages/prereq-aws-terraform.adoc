...
+	https://anypoint-anywhere.s3.amazonaws.com/pcp/private-cloud-provisioner-1.0.9.tar.gz?AWSAccessKeyId=AKIAI6LBJNQFR2V3CQWQ&Signature=Z3ffGPNs1vZ53%2BYVMgFhJxpeJbU%3D&Expires=1751333981.
...
. Record the image ID that is displayed by the `docker load` command. This is required in the following step.
