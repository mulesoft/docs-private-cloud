...
[IMPORTANT]
Your infrastructure team, or someone with AWS administrator level knowledge, must perform the following steps. If needed, contact your Customer Success Manager for assistance.
