...
+
`https://anypoint-anywhere.s3.amazonaws.com/pcp/private-cloud-provisioner-4.0.13.tar.gz.tar.gz?Expires=1827968341&Signature=jXWPj7fncm9MHdZA5M8uULePiO8%3D&AWSAccessKeyId=AKIAI6LBJNQFR2V3CQWQ`
+
. Copy the provisioner Docker image to the instance via SCP:
+
----
scp -i <guest>.pem ~/Downloads/private-cloud-provisioner-4.0.13.tar.gz ec2-user@W.X.Y.Z:/home/ec2-user
----
