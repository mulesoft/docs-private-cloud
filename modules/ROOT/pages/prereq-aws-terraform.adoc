...
+
----
https://onprem-standalone-installers.s3.amazonaws.com/pce2.0.1-aws-provisioner.tar.gz?Expires=1709789111&AWSAccessKeyId=AKIAI6LBJNQFR2V3CQWQ&Signature=4aQ4wJNuRDzCiz%2BF6iKfwZIUyPM%3D
----
