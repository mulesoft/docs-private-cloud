...
| TF_VAR_aws_selected_subnets_ids= | You can pass a list of subnets IDs where the instances will be launched on. If you reuse your own subnets, you need to set up Route Tables, NAT Gateways and Internet Gateway. For example: `["subnet-0a17317984065f98f", "subnet-0600b4befb27c7949", "subnet-02103e0c935eff75a"]`
