...
|===
| Name | Description
| TF_VAR_ami_name | Specifies the AMI name to be used for the instances. Use the AMI name, *NOT* the AMI ID. *Make sure the AMI doesn't provision any additional volumes*. If you do not set this variable, the provisioner uses the following AMI by default: `RHEL-7.6_HVM_GA-20181017-x86_64-0-Hourly2-GP2`
