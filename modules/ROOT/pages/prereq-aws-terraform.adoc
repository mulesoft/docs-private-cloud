...
+	https://anypoint-anywhere.s3.amazonaws.com/pcp/private-cloud-provisioner-2.1.0.tar.gz?AWSAccessKeyId=ASIA5N3VCMOYEU3PZCOS&Signature=k%2FwbmjbB0I9Yvr%2BtXqiHvnaY%2BUg%3D&x-amz-security-token=FwoGZXIvYXdzEKr%2F%2F%2F%2F%2F%2F%2F%2F%2F%2FwEaDCrNBKgbvClLWdNI9SLzARdri0xzJ8K50z58dewqLripn4Qebr81jKw%2BoqxeEEOEUuPnHGACTyoc8OOQpBgXf0nAryYO3lN48wvT8enk3OqsuT0uaAb1AZNUe53ZzvcL552y4MR97rGKhpZPjBEL%2BL%2BpAiHgky3KaTvJExLEHaiG5MEAW7wQveJdZGX96DRtak7Tf0jK5bRfvGk8JJJke72J3V%2BD18ktrhd2WtlpC6U4K%2Bq3PBrYfKEicNw7i0kaFnreSS50xxpXQ%2FhLVLL5aCCdKAXv43sP5n0JEuW%2Fg1LMUrfphijtTUC5SvAz4W621RfCuIYViuQipLlRSjbxF0pcqyi1vPPzBTIyiKsna%2BiT5O4o9XALw0aupDBBxXx%2FZfvQAaE6lk1iOg8rOl01ccLHrnC7CewZXSqPxnw%3D&Expires=1708314127
. Copy the provisioner Docker image to the instance via SCP:
+
----
scp -i <guest>.pem ~/Downloads/private-cloud-provisioner-2.1.0.tar.gz ec2-user@18.221.155.87:/home/ec2-user
----
...
+
----
docker load -i private-cloud-provisioner-2.1.0.tar.gz
----

. Perform a dry-run test:
+
----
docker run --rm --env-file pce.env artifacts.msap.io/mulesoft/core-paas-private-cloud-provisioner:v2.1.0 dry-run
----
+
...
+
----
docker run --rm --env-file pce.env artifacts.msap.io/mulesoft/core-paas-private-cloud-provisioner:v2.1.0 cluster-provision
----
+
