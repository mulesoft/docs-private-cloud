...
The Ops Center is a web-base management tool that enables you to manage and monitor Anypoint Platform Private Cloud Edition and perform the following types of tasks:
