...
| Mocking Service | Mocking Service | v2.15.1
...
| Anypoint Platform PCE | Anypoint Platform PCE packaging | v3.0
...
[%header%autowidth.spread]
.API Manager Policies for Anypoint Platform PCE Version 2.1
|===
| Policy | Version
| Basic authentication: Simple | 1.2.1
| Basic Authentication - LDAP | 1.3.0
