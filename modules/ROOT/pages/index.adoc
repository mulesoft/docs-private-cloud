...
???Can i deploy PCE on some local hosted VMs?
. If using AWS, what kind of sevice from AWS will i need ?
. What are the types of environments required to run PCE?bare metal, public cloud, private cloud...
???

== Anypoint Platform Private Cloud Edition Versus CloudHub
...
== New features included in Anypoint Platform Private Cloud Edition version 2.0
