...
The Anypoint Platform Private Cloud Edition includes the following application components when combined with CloudHub:
...
* Anypoint Exchange, which enables your organization to share various assets that can be reused across integration projects.
* Access Management
* Design Center, excluding Flow Designer

The following application components are not included when combined with CloudHub:
