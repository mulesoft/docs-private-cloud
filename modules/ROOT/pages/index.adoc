...
For Anypoint Platform PCE version 4.0, the following policies are included with API Manager:
...
== Add-On Features Supported by Anypoint Platform PCE Version 4.0
