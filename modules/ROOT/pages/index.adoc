...
The Anypoint Platform Private Cloud Edition includes the following application components when compared with what CloudHub has to offer:
...
The following application components are not included when compared with CloudHub functionality:
