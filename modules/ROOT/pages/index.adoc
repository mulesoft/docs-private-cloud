...
| Object Store	|   | X | Object Store v2 lets CloudHub applications store data and states across batch processes, Mule components, and applications, from within an application or by using the Object Store REST API.
| Anypoint MQ	|   | X | A multi-tenant, cloud messaging service that enables your to perform advanced asynchronous messaging scenarios between their applications
| API Testing	|   | X | Provides a testing framework that allows you to easily build automated tests for your integrations and APIs.
|===
