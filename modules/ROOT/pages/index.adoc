...
== Anypoint Monitoring Features Supported by Anypoint Platform PCE Version 3.0

[%header%autowidth.spread]
.Features Supported by Anypoint Platform PCE Version 3.0
|===
| Feature | Version
| Anypoint Monitoring | v0.6.2.0
| Anypoint Visualizer | v0.6.2.0
|===
