= Perform Additional Installation Tasks - WIP
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:page-aliases: prereq-gravity-check.adoc, install-diable-local-user.adoc 

There are some additional installation steps that you need to perform after the initial Anypoint Platform Private Cloud Edition installation.
...
== Disable Port 61009 After Installation

After installation is complete, close port 61009 in the cluster security group using the AWS Web console.
...
See xref:managing-via-the-ops-center.adoc#configure-log-forwarding[Configure Log Forwarding] for detailed steps on how to do this from the Ops Center.
