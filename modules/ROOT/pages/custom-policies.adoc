...
See the following corresponding documentation for the cloud version of Anypoint Platform for details: 
...
----
+
In the previous example, $ANYPOINT_DNS is set to the DNS for Anypoint Platform PCE. Replace the location and password with your JVM’s truststore for your environment.
