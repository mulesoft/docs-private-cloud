...
To use Anypoint Monitoring with more than two Anypoint Platform PCE installations, you must purchase additional monitoring instances. Contact your customer success representative for more information.
