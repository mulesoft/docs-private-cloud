...
Anypoint Platform Private Cloud Edition (Anypoint Platform PCE) includes support for Anypoint Monitoring.

Anypoint Monitoring is a suite of tools that provide feedback from Mule flows and components in your application network.


[IMPORTANT]
Anypoint Monitoring is an add-on to your Anypoint Platform PCE product. Contact your customer success representative for more information.
