...
[NOTE]
It is not supported to upgrade from an existing Openshift PCE 4.1.x cluster that's been installed with full admin privilege to 4.2.1 with no admin scope.
