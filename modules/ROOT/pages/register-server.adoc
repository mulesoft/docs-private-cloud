...
[[registering_servers]]
If you encountered an error when performing the steps in xref:runtime-manager/servers-create[Create a Server in Runtime Manager], perform the following steps:
