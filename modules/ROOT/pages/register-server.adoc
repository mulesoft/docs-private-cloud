...
For more information about the CA certificate truststore, refer to your JVM vendor's documentation: for example,  https://docs.oracle.com/[Oracle documentation^].
