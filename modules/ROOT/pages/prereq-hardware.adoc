...
The main purpose of the application data directory device is to store Monitoring Center Add-On application configuration and data. The minimum amount of space required is 250GB, but your use case might require more. It is important to allocate enough space for the dedicated device.
