...
|/ (root) | 10 GB | N/A |Make sure that you have at least 10GB in your home directory to download and unzip the installer file.|
|===
...
[NOTE]
Do not configure SSL certificates in your load balancer. TLS termination is handled by the platform with the certificates configured using Access Management. See xref:install-add-tasks.adoc[To Perform Additional Installation Tasks].
