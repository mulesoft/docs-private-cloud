...
[NOTE]
Contact your Customer Success Manager for assistance with verification of RAM, disk size, CPU cores, and other system requirements if you are unsure how to do this.
