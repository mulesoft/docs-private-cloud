...
|/ (root) | 25 GB | N/A | | You must have at least 25GB in your home directory to download and unzip the installer file.|
|===
...
|HDD 7 xref:prereq-hardware#influxdb-amv-device[InfluxDB AMV Device]| 250 GB |1500|/var/lib/data/influxdb | Stores InfluxDB data for Monitoring Center Add-On. The amount of space required should be at least 250 GB, but can vary depending on your specific use case. It is important to estimate the minimum size requirements and allocate enough space as a dedicated device ahead of time.
|HDD 7 xref:prereq-hardware#logstash-amv-device[logstash AMV Device]| 250 GB |1500|/var/lib/data/logstash | Stores Logstash data for Monitoring Center Add-On. The amount of space required should be at least 250 GB, but can vary depending on your specific use case. It is important to estimate the minimum size requirements and allocate enough space as a dedicated device ahead of time.
|/tmp (Installer) | 20 GB |N/A| |
...
xvdf    202:64   0  250G   0 disk /var/lib/stolon-amv
xvdg    202:64   0  250G   0 disk /var/lib/influxdb
xvdh    202:64   0  250G   0 disk /var/lib/logstash
