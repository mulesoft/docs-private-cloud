...
|`pceobjectstore`|1500| Stores Seaweed object store data. The amount of space required can vary depending on your specific use case. It is important to estimate the minimum size requirements and allocate enough space as a dedicated device ahead of time.
