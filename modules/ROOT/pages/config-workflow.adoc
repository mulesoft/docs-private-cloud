...
The following tasks are required for Anypoint Platform Private Cloud Edition. Otherwise, you cannot deploy and manage applications, register APIs, and use API Exchange on an Anypoint Platform environment running on your own local network. Refer to xref:install-checklist.adoc[Installation and Upgrade Checklist] for more information.
