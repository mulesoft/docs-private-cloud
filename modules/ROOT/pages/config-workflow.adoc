...
Review the following tasks after you complete Anypoint Platform Private Cloud installation. Many of these are required before you can successfully deploy and manage applications, register APIs, and use API Exchange on an Anypoint Platform environment running on your own local network.
