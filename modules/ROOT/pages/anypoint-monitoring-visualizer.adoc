...
. -f : (Required) name of the destination tar file - Default for backup : "dias-prov-k8s-am-influxdb-comp_YYYYMMDD" & Default for restore : "/var/lib/data/influxdb/backup/dias-prov-k8s-am-influxdb-comp_YYYYMMDD.tar.gz" - Backup will fail if file is already present in the backup path. Restore will fail if file is not present.
