...
***** 6-node environment: Maximum of 50 apps 
***** 3-node environment: Maximum of 100 apps
...
+
All 6-node environment recommendations and limitations apply to 3-node environments except for the 
following items:
