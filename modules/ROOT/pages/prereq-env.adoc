...
Adhere to the following recommendations and limitations when setting up your environment and deploying apps:
...
***** Maximum: 500 apps in a single environment 
**** Number of Clusters/Runtimes

***** Total: 800 runtimes, two nodes each with 400 Clusters 
**** Applications per Mule or Cluster
