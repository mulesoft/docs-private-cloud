...
[WARNING]
====
To successfully install or upgrade Anypoint Platform Private Cloud Edition, your organization’s operations, networking, and security teams must review the infrastructure prerequisites, including topology, hardware, software, network, and NFS, and verify successful completion of all tasks. This ensures your infrastructure meets the prerequisites for Anypoint Platform Private Cloud Edition. 
