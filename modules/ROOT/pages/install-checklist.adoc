...
Before you install Anypoint Platform Private Cloud Edition, your organization’s operations, networking, and security teams must review the listed infrastructure prerequisites, including Amazon Web Services (if applicable), hardware, software, network, and NFS, and verify successful completion of all prerequisites listed in this topic.
...
In addition, anyone that plans to install Anypoint Platform Private Cloud Edition must possess knowledge in the following areas:
