...
In addition, to install Anypoint Platform Private Cloud Edition, you must possess knowledge in the following areas:
...
| xref:prereq-network#verify-ssl-certificate-requirements[Verify SSL Certificate Requirements]
