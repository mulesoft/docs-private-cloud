...
[WARNING]
To successfully install or upgrade Anypoint Platform Private Cloud Edition, your organization’s operations, networking, and security teams must review the topology, hardware, software, network, and NFS requirements and verify successful completion of all tasks. This ensures your infrastructure meets the minimum hardware, operating system, and networking requirements for Anypoint Platform Private Cloud Edition.
...
| Set up AWS (if using AWS) | xref:prereq-aws-terraform.adoc[Amazon Web Services (AWS) Requirements]|
| Set up Bare Metal Servers (if using bare metal)|  |
|===
