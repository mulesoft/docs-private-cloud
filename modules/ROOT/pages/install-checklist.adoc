...
The two modes are mutually exclusive. You cannot change the storage mode on an existing cluster; the installer rejects mode changes to prevent orphaning data on the previous volumes.
