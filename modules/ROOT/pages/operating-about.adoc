...
See xref:managing-via-the-ops-center.adoc[Ops Center] to add or remove servers from the Anypoint Platform cluster as well as other changes you want to make after installation.
