...
Before running the installer, ensure that your system meets the minimum system requirements and that you have all information listed in the installation checklist.
...
//Choose Docker device - any guidance? I thought Docker was uninstalled, why would there be anything listed here? How do I know if there’s enough space???
+
