...
* The GUI installer provides a wizard that walks you through the Anypoint Platform Private Cloud Edition installation process. It enables you to specify configuration options, but it also requires you to open extra ports and a web browser to access the pages.
