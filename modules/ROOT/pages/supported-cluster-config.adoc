...
***** Limit to 50 Business Groups

**** Exchange

***** Maximum 30,000 Exchange Assets
...
***** Maximum number of servers: 1500
***** Maximum number of servers per server group: 20
***** Maximum servers per cluster: 8
...
***** Mule runtime engines under management
****** Maximum: 1500 single Mule runtime engines (or 750 Mule runtime clusters, consisting of 2 Mule runtime engines per cluster)
