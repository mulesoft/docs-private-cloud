...
For limitations onf using Anypoint Monitoring with Anypoint Platform PCE see xref:anypoint-monitoring.adoc[Anypoint Monitoring on Anypoint Platform PCE]
