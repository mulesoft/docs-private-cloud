= Supported Network Topologies for Anypoint Private Cloud
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

To ensure platform performance, stability, and high-availability, Anypoint Platform Private Cloud supports two network topologies, 3-node and 6-node, which are outlined in the following sections.
